#This code is adapted and modified from VisualOdometry by Nicolai Nielsen at 
...
class VisualOdometry():
    def __init__(self):
        #Use the game camera intrinsic matrix
        self.P = np.array([[92.0, 0.0, 160.0, 0],
                            [0.0, 92, 120.0, 0],
                            [0.0, 0.0, 1.0, 0]])
        ...
        #Create ORB Descriptors with Flann based Matcher
    ...
    def _form_transf(R, t):
        # Creates transformation matrix T = [R | t]
    ...
    def decomp_essential_mat(self, E, q1, q2):
        #Determine which  is the right [R | t] pair
